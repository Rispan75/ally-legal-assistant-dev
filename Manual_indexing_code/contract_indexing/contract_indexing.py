...
if __name__ == "__main__":
    ...
    #documents = [r"C:\Users\v-pandeyrish\Documents\Projects\Dekra\contract_documents\NDA - Adasky form with a Company - 2024.docx"]
    folder = "./contract_documents"
    for filename in os.listdir(folder):
        if filename.lower().endswith((".docx", ".pdf")):
            print(f"[PROCESSING] {filename}")
            process_document(os.path.join(folder, filename))
