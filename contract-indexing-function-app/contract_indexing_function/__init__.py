...
def main(req: func.HttpRequest) -> func.HttpResponse:
    logging.info("Indexing function is triggered.") 

## fetch input - filename from http request's json body
    try:
        logging.info("Inside process_all_documents.")
        return_value = contract_indexing.process_documents_from_blob()
        ...
        if return_value=="good":
            ...
            return func.HttpResponse(f"{return_value}", status_code=500)
